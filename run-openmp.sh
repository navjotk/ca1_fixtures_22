...
python ${artifacts_path}/multithreadrunner.py --basedir ${submission_path} --max-threads 40 --executable "op1,input_64_512_960.dat,kernel_5.dat,output_64_512_960x5.dat" --executable "op2,a.dat,b.dat,c.dat" --identifier ${submission_id} --results-file results.csv
% endfor
