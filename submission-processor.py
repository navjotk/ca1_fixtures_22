...
executables = [{'compile_command': "/opt/apps/alces/intel/psxe/2019u5/bin/icc op1_omp.c {artifacts_path}/main_op1_file.c -o op1 -std=c99 -qopenmp",
                'name': "op1", 'args': ['{artifacts_path}/input_64_512_960.dat', '{artifacts_path}/kernel_5.dat', '{artifacts_path}/output_64_512_960x5.dat']},
               {'compile_command': "/opt/apps/alces/intel/psxe/2019u5/bin/icc op2_omp.c {artifacts_path}/main_op2_file.c -o op2 -std=c99 -qopenmp",
               'name': "op2", 'args': ['{artifacts_path}/a.dat', '{artifacts_path}/b.dat', '{artifacts_path}/c.dat']}]
